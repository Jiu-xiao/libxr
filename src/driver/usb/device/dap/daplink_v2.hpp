 ...
 *   SWD backend via injected SwdPort instance.
...
template <typename SwdPort>
void DapLinkV2Class<SwdPort>::InitWinUsbDescriptors()
{
...
template <typename SwdPort>
void DapLinkV2Class<SwdPort>::UpdateWinUsbInterfaceFields()
{
...
template <typename SwdPort>
ConstRawData DapLinkV2Class<SwdPort>::GetWinUsbMsOs20DescriptorSet() const
{
...
template <typename SwdPort>
void DapLinkV2Class<SwdPort>::UnbindEndpoints(EndpointPool& endpoint_pool, bool in_isr)
{
  (void)in_isr;
  inited_ = false;
...
template <typename SwdPort>
void DapLinkV2Class<SwdPort>::OnDataOutComplete(bool in_isr, LibXR::ConstRawData& data)
{
  (void)in_isr;
...
template <typename SwdPort>
uint8_t DapLinkV2Class<SwdPort>::MapAckToDapResp(LibXR::Debug::SwdProtocol::Ack ack) const
{
  switch (ack)
  {
...
template <typename SwdPort>
void DapLinkV2Class<SwdPort>::DriveReset(bool release)
{
...
template <typename SwdPort>
void DapLinkV2Class<SwdPort>::DelayUsIfAllowed(bool /*in_isr*/, uint32_t us)
{
  LibXR::Timebase::DelayMicroseconds(us);
}
