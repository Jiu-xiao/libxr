...
{
 public:
  static constexpr const char* kControlInterfaceStringDefault = "XRUSB CDC Control";
  static constexpr const char* kDataInterfaceStringDefault = "XRUSB CDC Data";
...
#pragma pack(pop)
 ...
 public:
  ...
  CDCBase(Endpoint::EPNumber data_in_ep_num = Endpoint::EPNumber::EP_AUTO,
          ...
          const char* data_interface_string = kDataInterfaceStringDefault)
