...
- **manual**：需要具体系统或外设，由用户准备环境后调用。目前只有 [system](manual/system/README.md) 和 [driver](manual/driver/README.md) 的说明，还没有测试代码。
  Needs a particular system or peripheral and is called after the user sets it up. The [system](manual/system/README.md) and [driver](manual/driver/README.md) directories currently contain instructions only.
