...
NESTED_CONFIG_PRIORITY_SIGNATURE="Action property NestedAdmissionRespectsConfigPriority is violated"
NESTED_DEFERRED_PRIORITY_SIGNATURE="Action property NestedAdmissionRespectsDeferredPriority is violated"
NESTED_RETRY_CARRIER_SIGNATURE="Invariant BlockedTxHasCarrier is violated"
...
CONFIG_ABORT_EARLY_APPLY_SIGNATURE="Invariant NoEarlyApply is violated"
CONFIG_ABORT_INSIDE_STOP_IRQ_WITNESS_SIGNATURE="Invariant NoInsideStopIrqApplyWitness is violated"
CONFIG_ABORT_NO_WRITE_RESCAN_SIGNATURE="Invariant PostConfigWriteRescanned is violated"
CONFIG_ABORT_RETAINED_TX_RETRY_SIGNATURE="Invariant NoRetiredTxRetryAfterConfig is violated"
CONFIG_ABORT_UNSAFE_ERROR_SIGNATURE="Invariant StopCompletionRequiresDisabled is violated"
STM32_SCHEDULER_SPLIT_SIGNATURE="Invariant NoLostWake is violated"
STM32_SCHEDULER_RELEASE_SIGNATURE="Invariant NoPublishedRequestLoss is violated"
STM32_DMA_STALE_TC_SIGNATURE="Invariant DmaEnIsAuthoritative is violated"
STM32_DMA_NO_REPUBLISH_SIGNATURE="Invariant MaskedDomainHasRestoreCarrier is violated"
STM32_DMA_OLD_TERMINAL_WITNESS_SIGNATURE="Invariant NoOldTerminalCompletionWitness is violated"
...
TLC_CASES=(
  ...
  "UartNestedTxAdmission|UartNestedTxAdmission|UartNestedTxAdmission.cfg|0|"
  "UartNestedTxAdmissionLiveness|UartNestedTxAdmission|UartNestedTxAdmissionLiveness.cfg|0|"
  ...
  "UartConfigAbortJoin|UartConfigAbortJoin|UartConfigAbortJoin.cfg|0|"
  "Stm32IrqSchedulerCorrect|Stm32IrqScheduler|Stm32IrqSchedulerCorrect.cfg|0|"
  "Stm32DmaAbortRestoreCorrect|Stm32DmaAbortRestore|Stm32DmaAbortRestoreCorrect.cfg|0|"
  ...
  "UartNestedTxAdmissionNonAtomicConfig|UartNestedTxAdmission|UartNestedTxAdmissionNonAtomicConfig.cfg|13|${NESTED_CONFIG_PRIORITY_SIGNATURE}"
  "UartNestedTxAdmissionNonAtomicDeferred|UartNestedTxAdmission|UartNestedTxAdmissionNonAtomicDeferred.cfg|13|${NESTED_DEFERRED_PRIORITY_SIGNATURE}"
  "UartNestedTxAdmissionEphemeralRetry|UartNestedTxAdmission|UartNestedTxAdmissionEphemeralRetry.cfg|12|${NESTED_RETRY_CARRIER_SIGNATURE}"
  ...
  "UartConfigAbortJoinEarlyApply|UartConfigAbortJoin|UartConfigAbortJoinEarlyApply.cfg|12|${CONFIG_ABORT_EARLY_APPLY_SIGNATURE}"
  "UartConfigAbortJoinInsideStopIrqWitness|UartConfigAbortJoin|UartConfigAbortJoinInsideStopIrqWitness.cfg|12|${CONFIG_ABORT_INSIDE_STOP_IRQ_WITNESS_SIGNATURE}"
  "UartConfigAbortJoinNoWriteRescan|UartConfigAbortJoin|UartConfigAbortJoinNoWriteRescan.cfg|12|${CONFIG_ABORT_NO_WRITE_RESCAN_SIGNATURE}"
  "UartConfigAbortJoinRetainedTxRetry|UartConfigAbortJoin|UartConfigAbortJoinRetainedTxRetry.cfg|12|${CONFIG_ABORT_RETAINED_TX_RETRY_SIGNATURE}"
  "UartConfigAbortJoinUnsafeError|UartConfigAbortJoin|UartConfigAbortJoinUnsafeError.cfg|12|${CONFIG_ABORT_UNSAFE_ERROR_SIGNATURE}"
  "Stm32IrqSchedulerBrokenSplit|Stm32IrqScheduler|Stm32IrqSchedulerBrokenSplit.cfg|12|${STM32_SCHEDULER_SPLIT_SIGNATURE}"
  "Stm32IrqSchedulerBrokenRelease|Stm32IrqScheduler|Stm32IrqSchedulerBrokenRelease.cfg|12|${STM32_SCHEDULER_RELEASE_SIGNATURE}"
  "Stm32DmaAbortRestoreStaleTc|Stm32DmaAbortRestore|Stm32DmaAbortRestoreStaleTc.cfg|12|${STM32_DMA_STALE_TC_SIGNATURE}"
  "Stm32DmaAbortRestoreNoRepublish|Stm32DmaAbortRestore|Stm32DmaAbortRestoreNoRepublish.cfg|12|${STM32_DMA_NO_REPUBLISH_SIGNATURE}"
  "Stm32DmaAbortRestoreBrokenSplit|Stm32DmaAbortRestore|Stm32DmaAbortRestoreBrokenSplit.cfg|12|${STM32_SCHEDULER_SPLIT_SIGNATURE}"
  "Stm32DmaAbortRestoreOldTerminalWitness|Stm32DmaAbortRestore|Stm32DmaAbortRestoreOldTerminalWitness.cfg|12|${STM32_DMA_OLD_TERMINAL_WITNESS_SIGNATURE}"
)
