 ...
 *        concurrent bounded MPMC queue behavior.
 * @details 该入口包含生产者/消费者并发压力，runner 中应归入 `RTOS` 及以上集合。
 *          This entry includes producer/consumer stress cases, so the runner must
 *          classify it as `RTOS` or higher.
 */
