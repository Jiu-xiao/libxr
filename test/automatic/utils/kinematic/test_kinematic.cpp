 ...
 * @brief 双关节运动学求解测试 / Two-joint kinematics test.
 *
 * 建立双关节模型并求解目标位姿，检查末端的位置误差和四元数误差。
 * Build a two-joint model, solve for a target pose and check endpoint position and
 * quaternion errors.
 */
