 ...
 * @brief FloatEncoder 编解码测试 / FloatEncoder encoding and decoding tests.
 *
 * 检查量化误差、端点、越界限幅、零值、单比特编码和无穷值处理。
 * Check quantization error, endpoints, clamping, zero, one-bit encoding and infinities.
 */
