/**
 * @file test_pid.cpp
 * @brief PID 响应与状态测试 / PID response and state tests.
 *
 * 检查积分和输出限制、饱和后的积分处理、导数输入、状态重置、无效输入和周期误差。
 * Check integral and output limits, anti-windup, derivative input, reset, invalid inputs
 * and cyclic error.
 */
