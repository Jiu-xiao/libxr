 ...
 * @brief 消息测试数据类型 / Payload types shared by message tests.
 *
 * 提供非平凡复制、缓存行对齐和可截短字段的数据，用于 Topic 与 Packet 测试。
 * Provide nontrivially copied, cache-line-aligned and prefix payloads for Topic and
 * Packet tests.
 */
