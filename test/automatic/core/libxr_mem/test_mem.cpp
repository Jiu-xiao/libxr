 ...
 * @file test_mem.cpp
 * @brief 检查内存填充、复制和比较。 /
 * Tests memory fill, copy and comparison.
 *
 * 包含零长度、非对齐地址和复制范围边界；比较结果与 memcmp 的正负号一致。
 * Includes zero lengths, unaligned addresses, copy bounds and memcmp sign checks.
 */
