 ...
 * @brief 编译检查：关闭整数和文本打印后，拒绝相应参数及格式。 /
 * Compile check: disabled integer and text printing rejects their arguments and formats.
 *
 * 同时确认指针和浮点格式仍可用。
 * Also checks that pointer and float formats remain available.
 */
