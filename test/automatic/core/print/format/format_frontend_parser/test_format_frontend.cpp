 ...
 * @brief 检查花括号格式的参数索引、填充和各类数据输出。 /
 * Tests brace-format argument indexing, padding and formatted values.
 *
 * 包含浮点边界、溢出错误、字符串适配和直接写入。
 * Includes float boundaries, overflow errors, string adapters and direct writes.
 */
